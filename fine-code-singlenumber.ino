 ...
 * Version: 2.1 (Single Emergency Contact)
 * Date: 2024
 */
...
void setup() {
  ...
  delay(1000);
  Serial.println("\n\n========================================");
  Serial.println(" SMART HELMET SYSTEM v2.1 (SINGLE CONTACT)");
  Serial.println("========================================\n");
  ...
  if(!display.begin(SSD1306_SWITCHCAPVCC, 0x3C)) {
    ...
    display.println("Smart Helmet v2.1");
    display.println("(Single Contact)");
